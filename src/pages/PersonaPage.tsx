...
const SEED_PERSONAS: Omit<Persona, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  {
    name: 'Mark O', role: 'Promoter', avatar: '🎤',
    goals: [
      'Fill fight cards with competitive, entertaining, reliable matchups',
      'Judge a fighter fast: record AND how they win (KO/sub vs decision)',
      'Match on weight class, experience level and fighting style',
      'See proof — fight footage — and have a clear way to make contact',
    ],
    activities: [
      'Opens a fighter\'s public profile from a shared link — no login',
      'Scans record, finish rate, weight class and style above the fold in seconds',
      'Scouts and shortlists fighters for upcoming event cards',
      'Confirms availability, weight-class fit and medical readiness',
      'Reaches out to the coach/fighter to make a bout offer',
    ],
    painPoints: [
      'Hard to verify records, finish rate and availability quickly',
      'Last-minute pull-outs due to injury or weight issues',
      'Fighter info is scattered across DMs, spreadsheets and social media',
      'No single trusted, up-to-date profile to base a match on',
    ],
    context: 'Laptop and phone — often opens the shared link on mobile. Runs 2–6 events per year. Works with multiple gyms and managers simultaneously. Never logs in; decides in under a minute.',
  },
  {
